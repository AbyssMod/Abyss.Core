...
public static class GreatWhite
{
    ...
    public static ZoneEnum forbiddenZones = ZoneEnum.NONE | ZoneEnum.THE_MARROWS | ZoneEnum.GALE_CLIFFS | ZoneEnum.STELLAR_BASIN | ZoneEnum.TWISTED_STRAND | ZoneEnum.DEVILS_SPINE;
     ///<json>
     /// {
     ///    "$content": [],
